 ...
 */
public class LProtocolClient3026Test {
...
//            t.msgBody = "370200|DBP081002|".getBytes();          // 确认错误
//            t.msgBody = "370200|DBP081003|".getBytes();          // 已补票
            t.msgBody = "370200|DBP081004|".getBytes();          // 正确
//            t.msgBody = "370200|DBP081005|".getBytes();          // 已补票
//            t.msgBody = "370200|DBP081006|".getBytes();          // 已补票
