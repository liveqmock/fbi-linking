package apps.fiskfq.gateway.domain.base;
...
@XStreamAlias("root")
public class ToaXml extends Toa {
    ...
    public Toa toToa(String xml) {
        ...
        xs.processAnnotations(ToaXml.class);
        return (ToaXml) xs.fromXML(xml);
    }
    ...
    public static void main(String[] args) {
        ...
        ToaXml toa = new ToaXml();
        toa = (ToaXml) toa.toToa(str);
